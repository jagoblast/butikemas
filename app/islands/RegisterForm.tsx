// GANTI IMPOR DARI 'react' MENJADI 'hono/jsx'
...
export default function RegisterForm() {
  ...
  // Hapus React.ChangeEvent, gunakan any atau Event bawaan web
      ...
      <form onSubmit={handleRegister} noValidate className="space-y-4">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input name="email" type="email" placeholder="nama@email.com" value={formData.email} onInput={handleChange} required className="w-full bg-white border border-navy-300 rounded-xl pl-10 pr-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-gold-400 focus:border-gold-400 transition-all text-navy-900 placeholder:text-navy-300" />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input name="phone" type="tel" placeholder="081234567890" value={formData.phone} onInput={handleChange} className="w-full bg-white border border-navy-300 rounded-xl pl-10 pr-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-gold-400 focus:border-gold-400 transition-all text-navy-900 placeholder:text-navy-300" />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input name="confirmPassword" type={showConfirmPassword ? 'text' : 'password'} placeholder="Ulangi password" value={formData.confirmPassword} onInput={handleChange} required className="w-full bg-white border border-navy-300 rounded-xl pl-10 pr-12 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-gold-400 focus:border-gold-400 transition-all text-navy-900 placeholder:text-navy-300" />
