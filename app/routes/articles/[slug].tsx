  ...
  return c.render(
    <div className="bg-white min-h-screen">
      ...
      <div className="w-full h-[40vh] md:h-[60vh] bg-navy-900 relative">
        {article.image_url && (
          <img src={article.image_url} alt={article.title} className="w-full h-full object-cover opacity-70" />
        )}
      ...
      <div className="max-w-3xl mx-auto px-5 sm:px-6 relative -mt-32 md:-mt-48 z-10 pb-24">
        <div className="bg-white rounded-3xl p-6 md:p-12 shadow-xl border border-gray-100">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-navy-900 font-serif leading-tight mb-8">
            {article.title}
          </h1>
          ...
          {/* Konten Text - Dalam aplikasi nyata sebaiknya diparsing dengan markdown, di sini kita render text biasa dengan spasi */}
